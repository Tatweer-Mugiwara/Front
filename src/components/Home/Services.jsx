      ...
      <div>
        <div className="relative max-w-[20rem] border-mainColor border-2 bg-mainColor text-white pt-12 pb-5 px-5">
          <img
            ...
            alt=""
          />
          <h2 className="text-lg font-bold mb-5">Real Time Traking</h2>
          <p className="text-sm">
      ...
      <div>
        <div className="relative max-w-[20rem] border-mainColor border-2 pt-12 pb-5 px-5">
          <img
            ...
            alt=""
          />
          <h2 className="text-lg font-bold mb-5">Optimized Route Planning</h2>
          <p className="text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
            perferendis beatae soluta nulla tenetur numquam.
          </p>
      ...
      <div>
        <div className="relative max-w-[20rem] border-mainColor border-2  pt-12 pb-5 px-5">
          <img
            ...
            alt=""
          />
          <h2 className="text-lg font-bold mb-5">Load Maximization</h2>
          <p className="text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
            perferendis beatae soluta nulla tenetur numquam.
          </p>
      ...
      <div>
        <div className="relative max-w-[20rem] border-mainColor border-2  pt-12 pb-5 px-5">
          <img
            ...
            alt=""
          />
          <h2 className="text-lg font-bold mb-5">Seamless Operational Coordination</h2>
          <p className="text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id. Amita! sandos.
          </p>
        </div>
      </div>
    </div>
